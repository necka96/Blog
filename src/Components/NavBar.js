...
import { SocialIcon } from 'react-social-icons';
 function NavBar() {
  return (
   ...
   className="inline-flex items-center py-6 px-3 mr-1 md:mr-4 text-blue-100 hover:text-yellow-300 text-lg md:text-4xl font-bold sans-serif tracking-widest" >
    Home
   </NavLink>
    <NavLink to="/post"
